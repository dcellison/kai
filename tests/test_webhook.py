    ...
    async def test_start_lan_listener_exposes_only_workshop_client_routes(
        ...
        try:
            ...
            assert lan_paths == {
                ...
                "/v1/direct-messages/{channel_id}/archive",
                "/v1/direct-messages/{channel_id}/restore",
                "/v1/channels/{channel_id}/members",
                "/v1/channels/{channel_id}/members/{principal_id}/add",
                "/v1/channels/{channel_id}/members/{principal_id}/remove",
                "/v1/channels/{channel_id}/timeline",
                "/v1/channels/{channel_id}/unread",
                "/v1/channels/{channel_id}/read-position",
                "/v1/channels/{channel_id}/messages/{message_id}",
                "/v1/channels/{channel_id}/threads/{root_message_id}",
                "/v1/channels/{channel_id}/threads/{root_message_id}/unread",
                "/v1/channels/{channel_id}/threads/{root_message_id}/follow",
                "/v1/channels/{channel_id}/threads/{root_message_id}/unfollow",
                "/v1/channels/{channel_id}/threads/{root_message_id}/read-position",
                "/v1/channels/{channel_id}/events",
                "/v1/channels/{channel_id}/messages/{message_id}/reactions",
                "/v1/channels/{channel_id}/messages/{message_id}/reactions/{reaction}/reactors",
                ...
                "/v1/memory/conflicts",
                "/v1/memory/conflicts/{claim_id}",
                "/v1/memory/conflicts/{claim_id}/resolve",
                "/v1/memory/forgotten",
                "/v1/memory/forgotten/{claim_id}/restore",
                "/v1/memory/projections",
                "/v1/memory/projections/audit",
                "/v1/memory/projections/retry",
                "/v1/memory/reconciliation",
                "/v1/memory/reconciliation/{audit_id}/candidates",
                "/v1/memory/reconciliation/{audit_id}/candidates/{candidate_id}/decision",
                "/v1/memory/reconciliation/{audit_id}/actions/bulk",
                "/v1/memory/reconciliation/{audit_id}/apply",
                "/v1/memory/reconciliation/triage/{plan_id}/groups",
                "/v1/memory/reconciliation/triage/{plan_id}/groups/{group_id}/decision",
                "/v1/memory/reconciliation/triage/{plan_id}/safe/preview",
