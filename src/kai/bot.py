...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # JSONL remains a compatibility archive for routes that have not crossed
    # canonical execution. Protected private text reads and writes only the
    # Workshop timeline; exact durable replays therefore need no file guard.
    user_log = (
